 ...
 */
export const ROOK_HOME_ROOK_DROP_L1: LessonStep[] = [
  {
    type: "guided",
    title: "自陣への飛車打ち（Lv1）: ガイド",
    sfen: "position sfen 4k4/9/9/9/9/9/9/9/4K4 b 2R 1",
    orientation: "sente",
    substeps: [
      {
        prompt: "まずは形を作ろう。自陣への飛車打ちの“入口”として、ここに打ってみてね。",
        arrows: [{ to: sq(5, 5), kind: "drop", dir: "hand", hand: "sente" }],
        highlights: [sq(5, 5)],
        expectedMoves: [{ kind: "drop", piece: "R", to: sq(5, 5) }],
        after: "auto",
      ...
      },
      {
        ...
        highlights: [sq(5, 4)],
        expectedMoves: [{ kind: "drop", piece: "R", to: sq(5, 4) }],
        after: "auto",
  ...
  },
  {
    ...
    problems: [
      ...
      },
      {
        ...
        sfen: "position sfen 4k4/9/9/9/9/9/9/9/4K4 b 2R 1",
        expectedMoves: [{ kind: "drop", piece: "R", to: sq(4, 5) }],
        hints: {
      ...
      },
      {
        ...
        sfen: "position sfen 4k4/9/9/9/9/9/9/9/4K4 b 2R 1",
        expectedMoves: [{ kind: "drop", piece: "R", to: sq(6, 5) }],
        hints: {
      ...
      },
      {
        ...
        sfen: "position sfen 4k4/9/9/9/9/9/9/9/4K4 b 2R 1",
        expectedMoves: [{ kind: "drop", piece: "R", to: sq(4, 4) }],
        hints: {
      ...
      },
      {
        ...
        sfen: "position sfen 4k4/9/9/9/9/9/9/9/4K4 b 2R 1",
        expectedMoves: [{ kind: "drop", piece: "R", to: sq(6, 4) }],
        hints: {
      ...
      },
      {
        ...
        sfen: "position sfen 4k4/9/9/9/9/9/9/9/4K4 b 2R 1",
        expectedMoves: [{ kind: "drop", piece: "R", to: sq(5, 6) }],
        hints: {
      ...
      },
      {
        ...
        sfen: "position sfen 4k4/9/9/9/9/9/9/9/4K4 b 2R 1",
        expectedMoves: [{ kind: "drop", piece: "R", to: sq(5, 3) }],
        hints: {
